...
---------------------------------------------------*/
	...
	window.ScrollEffects = function() {
		...
		if (isMobile()) {
			...
			$('.smooth-scroll main, .has-parallax, nav, .tanisha-slider-wrapper:not(.content-slider), .showcase-lists .tanisha-sync-slider, .next-project-image-wrapper, .slider-fixed-content').css({'height': winHeight});
		...
		if ($('#tanisha-page-content').hasClass("light-content")) {
			if ($('#project-nav').hasClass("change-header")) {
		  		imagesLoaded('body', function() {
					setTimeout(function() {	
						var pageNav = document.querySelector('#project-nav.change-header');
						if (pageNav) {
							var pageContent = document.querySelector('#tanisha-page-content');	
							var nextPageCaptionParallax = gsap.to('.page-nav-caption', {
								scrollTrigger: {
									trigger: pageNav,
									start: "top 8%",
		...
		if ($('#tanisha-page-content').hasClass("dark-content")) {
			if ($('#project-nav').hasClass("change-header")) {
		  		imagesLoaded('body', function() {
					setTimeout(function() {	
...
---------------------------------------------------*/	
	...
	window.FirstLoad = function() {
		...
		if ($("#tanisha-page-content").hasClass("light-content")) {
			...
			gsap.to("main", {duration: 0.5, backgroundColor: document.querySelector("#tanisha-page-content").getAttribute("data-bgcolor"), ease:Power2.easeInOut});
		...
		$('a.ajax-link').on('click', function() {
			...
			gsap.to("nav", {duration: 0.3, backgroundColor: document.querySelector("#tanisha-page-content").getAttribute("data-bgcolor")});
				  ...
				  $body.on('mouseup mousemove', function handler(evt) {
					if (evt.type === 'mouseup') {
					  ...
					  $('#itemsWrapperLinks .trigger-item-link, #itemsWrapperLinks .trigger-item-link-secondary').on('click', function() {					
							...
							if (!$('#tanisha-page-content').hasClass("light-content")) {
								...
								if (!$('.portfolio').hasClass("portfolio-shortcode")) {
									if (!parent_item.hasClass("change-header")) {
										$('#tanisha-page-content').delay(1200).queue(function(next){							
							...
							$('.tanisha-slider .trigger-item').each(function(){
		...
		if (!$("body").hasClass("disable-ajaxload")) {
			...
			if ($("#itemsWrapper").hasClass("no-fitthumbs")) {
				...
				$('#itemsWrapperLinks .trigger-item-link').on('click', function() {
				  	...
				  	const fadeOutTargets = $('#hero, #show-filters, .tanisha-slider, .item, .item-caption-wrapper, #page-nav, footer, .fadeout-element');				  	
				  	const ball = $('#ball');
...
---------------------------------------------------*/
	...
	window.Sliders = function() { 
		...
		if( $('.content-slider').length > 0 ){
			...
			slider = new tanishaSlider('.content-slider', { 
			...
			$(".slider-button-prev").mouseenter(function(e) {
				if ($(this).parents(".tanisha-slider-wrapper").hasClass("light-cursor")) {
					$("body").addClass("drag-cursor-white");
					gsap.to('#ball', {duration: 0.2, borderWidth: '2px', scale: 1, borderColor:'#fff'});
				} else if ($(this).parents(".tanisha-slider-wrapper").hasClass("dark-cursor")) {
			...
			$('.content-slider.looped-carousel .tanisha-slider, .content-slider.small-looped-carousel .tanisha-slider').on('mouseenter mousemove', function() {	
...
---------------------------------------------------*/
	...
	window.Lightbox = function() {
		...
		function showDetails(item) {
			...
			$('body').prepend(`<div class="tanisha-img-popup">
				<div class="tanisha-img-popup-bg-close"></div>				
				<div class="tanisha-img-popup-viewport">
					<div class="tanisha-img-popup-preloader"><div></div><div></div><div></div><div></div></div>					
					<img />
					<div class="tanisha-img-popup-close link"></div>						
				</div>				
				<div class="tanisha-img-popup-prev link"></div>
				<div class="tanisha-img-popup-next link"></div></div>`);
			
			const details = document.querySelector('.tanisha-img-popup');
			const detailsBgClose = document.querySelector('.tanisha-img-popup-bg-close');
			const detailsClose = document.querySelector('.tanisha-img-popup-close');
			const detailsPreloader = document.querySelector('.tanisha-img-popup-preloader');
			const detailImage = document.querySelector('.tanisha-img-popup img');
			const detailPrev = document.querySelector('.tanisha-img-popup-prev');
			const detailNext = document.querySelector('.tanisha-img-popup-next');
		...
		function showVideoDetails(event, item) {
			...
			$('body').prepend(`<div class="tanisha-video-popup">
				<div class="tanisha-video-popup-bg-close"></div>				
				<div class="tanisha-video-popup-viewport">
					<div class="tanisha-video-popup-preloader"><div></div><div></div><div></div><div></div></div>					
					<iframe class="tanisha-video-popup-iframe" frameborder="0" allow="autoplay"></iframe>
					<div class="tanisha-video-popup-close link"></div>						
				</div>				
				<div class="tanisha-img-video-prev link"></div>
				<div class="tanisha-img-video-next link"></div></div>`);
			
			const details = document.querySelector('.tanisha-video-popup');
			const detailsBgClose = document.querySelector('.tanisha-video-popup-bg-close');
			const detailsClose = document.querySelector('.tanisha-video-popup-close');
			const detailsPreloader = document.querySelector('.tanisha-video-popup-preloader');
			const detailIframe = document.querySelector('.tanisha-video-popup iframe');
...
---------------------------------------------------*/
	...
	window.Core = function() {
		...
		if (!isMobile() && !$('body').hasClass("disable-cursor")) {
			...
			$(".tanisha-button .sticky.left").mouseenter(function(e) {		  
				var rcBounds = $(this)[0].getBoundingClientRect();		  
			...
			$(".tanisha-button .sticky.right").mouseenter(function(e) {		  
				var rcBounds = $(this)[0].getBoundingClientRect();		  
			...
			$(".tanisha-button .parallax-wrap.icon-wrap").mouseenter(function(e) {
			...
			$(".tanisha-button .sticky").mouseenter(function(e) {
				if ($('#tanisha-page-content').hasClass("light-content")) {
			...
			$(".tanisha-button .parallax-wrap").mouseenter(function(e) {
				if ($('#tanisha-page-content').hasClass("light-content")) {
			...
			//Blog Hover Effects			
			$("#blog-page-nav .page-numbers li a, .post-page-numbers, #post-content a, #post-form a, #post-comments a, .wp-block-search__button, .tanisha-sidebar-widget a").mouseenter(function(e) {	
				gsap.to('#ball', {duration: 0.2, borderWidth: '1px', scale: 1, opacity:0});
			});	
					
			$("#blog-page-nav .page-numbers li a, .post-page-numbers, #post-content a, #post-form a, #post-comments a, .wp-block-search__button, .tanisha-sidebar-widget a").mouseleave(function(e) {
				gsap.to('#ball', {duration: 0.3, borderWidth: '4px', scale:0.5, opacity:1});
			});
		}
			  ...
			  $(window).on('popstate', function() {
				...
				section.load(url+' .cd-main-content > *', function(event){
				  // load new content and replace <main> content with the new one
				 	...
				 	var tanisha_title = event.match(/<title[^>]*>([^<]+)<\/title>/)[1];
					$('head title').html( tanisha_title );
